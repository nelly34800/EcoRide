...
showJourneys("Covoiturages à venir", $pending, "Démarrer covoiturage", "lib/start_carpool.php", true);
showJourneys("Covoiturages complets", $complet, "Démarrer covoiturage", "lib/start_carpool.php", false);
showJourneys("Covoiturages en cours", $ongoing, "Arrivée à destination", "lib/arrival_carpool.php", true);
