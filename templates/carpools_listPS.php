        ...
        foreach ($journeys as $journey) {
            ...
            echo "<td class='d-none d-md-table-cell'>
                        <form method='POST' action='$action'>
                            ...
                            <a href='sup_covoiturage.php?id=" . $journey['id'] . "' class='btn btn-dark m-2' onclick='return confirm(\"Êtes-vous sûr de vouloir supprimer ce covoiturage ?\");'>Supprimer le covoiturage</a>
                        </form>
                    </td>
            </tr>";
        }
...
showJourneys("Covoiturages à venir", $pending, "Démarrer covoiturage", "lib/start_carpoolPS.php", true);
showJourneys("Covoiturages complets", $complet, "Démarrer covoiturage", "lib/start_carpoolPS.php", false);
showJourneys("Covoiturages en cours", $ongoing, "Arrivée à destination", "lib/arrival_carpoolPS.php", true);
