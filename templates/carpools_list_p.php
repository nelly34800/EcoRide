...
showReservations("Covoiturages à venir", $upcoming, "", "", "", "", "annuler trajet", "sup_reservation.php", "", "");
showReservations("Covoiturages en cours", $ongoing, "Valider trajet", "lib/validate_journey.php", "Signaler problème", "signaler_probleme.php");
showReservations("Historique des covoiturages", $completed);
