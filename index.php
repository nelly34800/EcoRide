...
<div class="container p-4">
    <form class="bar row g-3" action="index.php" method="GET">
        <div class="col-auto">
            ...
            <input class="bar-content pt-1" type="text" name="place_departure" id="place_departure" value="<?= htmlspecialchars($_GET['place_departure'] ?? ''); ?>" placeholder="...">
        ...
        <div class="col-auto">
            ...
            <input class="bar-content pt-1" type="text" name="place_arrival" id="place_arrival" value="<?= htmlspecialchars($_GET['place_arrival'] ?? ''); ?>" placeholder="...">
